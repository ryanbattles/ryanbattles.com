...
export const DATA = {
  ...
  description:
    "Just a marketing guy that loves to build things with technology and help others do the same.",
  summary:
    "My path into marketing started with an unexpected situation: my wife informed me that we were having *twins*.\n\nThis was our first pregnancy and as a private school teacher, the cost of daycare for two children nearly matched my salary. So we decided I would become a stay-at-home dad while my wife continued her career training. Newborn twins are plenty of work, but I still found a couple of hours during naptimes to take on a freelance client or two. What began as a practical way to earn additional income grew within a year into full-time client work.\n\nI named the new business **Jovia Web Studio**, after the middle names of my twins — Joy and Olivia.\n\nRunning Jovia lasted about 4 years, with notable clients including **Google, Dartmouth, Save the Children, Kind Bars, and the YMCA**. As much as I enjoyed running my agency, I made the decision to wind things down and accept a role as a lead software engineer for **Crushpath** — a multi-million dollar venture-backed startup in San Francisco. After a couple of fun years where I made friends and grew my skillset, I realized that it was time to move on. I partnered with a friend to build the accounting and time-tracking app **Harpoon**, which became the exact tool he and I wished existed while running our agencies. I also created the course *SaaS Marketing Essentials*, using it as an excuse to interview marketers and entrepreneurs to learn from their growth tactics, and synthesizing my own ideas on marketing into something others can learn from as well.\n\nAnother friend was working for a software startup called Wastebits, whose goal was to modernize the outdated processes around industrial waste. I knew nothing of this sector at the time, but could help them out with marketing as a contractor. After a few months working with the team, I knew I wanted a full-time position, and now I am the director of marketing at **Wastebits**, spending the past decade helping companies track and reduce waste send to landfills, and implement sustainable practices.\n\nAlong the way, I've learned that **good marketing is rarely about making more noise**. It is about understanding the audience, crafting a compelling message that grabs attention, and tracking what works.\n\nToday, I'm especially energized by the AI era because it rewards the kind of range I've built over my career. I've always been drawn to the big picture: how strategy, messaging, design, and data combine for effective execution. Modern tools remove many of the old bottlenecks, making it possible to move faster from idea to outcome.\n\nHowever, **speed alone is not the advantage**. As our lives fill with more content, more tools, and more computer-generated output, the real advantage belongs to those who can earn attention through building trust. That is where my passion is now: using the speed of new tools to apply the timeless principles of **attention, communication, and trust** in a marketing ecosystem that drives growth.\n\nThe game may be changing, but the finish line is the same.",
...
skillGroups: [
  ...
  contact: {
    ...
    social: {
      ...
      Instagram: {
        name: "Instagram",
        url: "https://www.instagram.com/ryan_loves_coffee/",
